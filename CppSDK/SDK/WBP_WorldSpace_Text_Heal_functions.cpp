...
#include "WBP_WorldSpace_Text_Heal_classes.hpp"
#include "WBP_WorldSpace_Text_Heal_parameters.hpp"
...
void UWBP_WorldSpace_Text_Heal_C::SetText(const class FText& Text_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_WorldSpace_Text_Heal_C", "SetText");

	Params::WBP_WorldSpace_Text_Heal_C_SetText Parms{};
...
void UWBP_WorldSpace_Text_Heal_C::OnAnimationFinished(const class UWidgetAnimation* Animation_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_WorldSpace_Text_Heal_C", "OnAnimationFinished");

	Params::WBP_WorldSpace_Text_Heal_C_OnAnimationFinished Parms{};
