...
static_assert(alignof(BP_FakeWall_C_ExecuteUbergraph_BP_FakeWall) == 0x000008, "Wrong alignment on BP_FakeWall_C_ExecuteUbergraph_BP_FakeWall");
static_assert(sizeof(BP_FakeWall_C_ExecuteUbergraph_BP_FakeWall) == 0x000020, "Wrong size on BP_FakeWall_C_ExecuteUbergraph_BP_FakeWall");
static_assert(offsetof(BP_FakeWall_C_ExecuteUbergraph_BP_FakeWall, EntryPoint) == 0x000000, "Member 'BP_FakeWall_C_ExecuteUbergraph_BP_FakeWall::EntryPoint' has a wrong offset!");
static_assert(offsetof(BP_FakeWall_C_ExecuteUbergraph_BP_FakeWall, CallFunc_IsValid_ReturnValue) == 0x000004, "Member 'BP_FakeWall_C_ExecuteUbergraph_BP_FakeWall::CallFunc_IsValid_ReturnValue' has a wrong offset!");
