...
// Package: BP_AbilityInstant_StatusEffect
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"BP_AbilityInstant_StatusEffect_C">();
	}
	static class ABP_AbilityInstant_StatusEffect_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_AbilityInstant_StatusEffect_C>();
	}
};
