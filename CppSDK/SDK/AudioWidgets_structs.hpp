...
public:
	...
	struct FSlateFontInfo                         Font;                                              // 0x0470(0x0068)(Edit, BlueprintVisible, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FAudioMeterStyle) == 0x0004E0, "Wrong size on FAudioMeterStyle");
...
public:
	...
	struct FSlateFontInfo                         LabelTextFont;                                     // 0x0038(0x0068)(Edit, BlueprintVisible, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         DesiredWidth;                                      // 0x00A0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         DesiredHeight;                                     // 0x00A4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FSampledSequenceValueGridOverlayStyle) == 0x0000A8, "Wrong size on FSampledSequenceValueGridOverlayStyle");
...
static_assert(offsetof(FSampledSequenceValueGridOverlayStyle, DesiredWidth) == 0x0000A0, "Member 'FSampledSequenceValueGridOverlayStyle::DesiredWidth' has a wrong offset!");
static_assert(offsetof(FSampledSequenceValueGridOverlayStyle, DesiredHeight) == 0x0000A4, "Member 'FSampledSequenceValueGridOverlayStyle::DesiredHeight' has a wrong offset!");
...
{
public:
	struct FSampledSequenceValueGridOverlayStyle  ValueGridStyle;                                    // 0x0008(0x00A8)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
public:
	...
	struct FSlateFontInfo                         TicksTextFont;                                     // 0x0118(0x0068)(Edit, BlueprintVisible, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         TicksTextOffset;                                   // 0x0180(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FSlateColor                            BackgroundColor;                                   // 0x0184(0x0014)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FFixedSampleSequenceRulerStyle) == 0x000280, "Wrong size on FFixedSampleSequenceRulerStyle");
...
static_assert(offsetof(FFixedSampleSequenceRulerStyle, TicksTextOffset) == 0x000180, "Member 'FFixedSampleSequenceRulerStyle::TicksTextOffset' has a wrong offset!");
static_assert(offsetof(FFixedSampleSequenceRulerStyle, BackgroundColor) == 0x000184, "Member 'FFixedSampleSequenceRulerStyle::BackgroundColor' has a wrong offset!");
static_assert(offsetof(FFixedSampleSequenceRulerStyle, BackgroundBrush) == 0x0001A0, "Member 'FFixedSampleSequenceRulerStyle::BackgroundBrush' has a wrong offset!");
static_assert(offsetof(FFixedSampleSequenceRulerStyle, DesiredWidth) == 0x000270, "Member 'FFixedSampleSequenceRulerStyle::DesiredWidth' has a wrong offset!");
static_assert(offsetof(FFixedSampleSequenceRulerStyle, DesiredHeight) == 0x000274, "Member 'FFixedSampleSequenceRulerStyle::DesiredHeight' has a wrong offset!");
...
public:
	...
	struct FSampledSequenceValueGridOverlayStyle  ValueGridStyle;                                    // 0x0290(0x00A8)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FAudioOscilloscopePanelStyle) == 0x0004C0, "Wrong size on FAudioOscilloscopePanelStyle");
...
static_assert(offsetof(FAudioOscilloscopePanelStyle, ValueGridStyle) == 0x000290, "Member 'FAudioOscilloscopePanelStyle::ValueGridStyle' has a wrong offset!");
