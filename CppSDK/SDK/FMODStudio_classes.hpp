...
{
public:
	class UFMODEvent*                             Event;                                             // 0x0230(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMap<class FName, float>                      ParameterCache;                                    // 0x0238(0x0050)(Edit, BlueprintVisible, SimpleDisplay, NativeAccessSpecifierPublic)
	class FString                                 ProgrammerSoundName;                               // 0x0288(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bEnableTimelineCallbacks : 1;                      // 0x0298(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bAutoDestroy : 1;                                  // 0x0298(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bStopWhenOwnerDestroyed : 1;                       // 0x0298(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_299[0x7];                                      // 0x0299(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TMulticastInlineDelegate<void()>              OnEventStopped;                                    // 0x02A0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnSoundStopped;                                    // 0x02B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const class FString& Name, int32 Position)> OnTimelineMarker;      // 0x02C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(int32 Bar, int32 Beat, int32 Position, float Tempo, int32 TimeSignatureUpper, int32 TimeSignatureLower)> OnTimelineBeat; // 0x02D0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	struct FFMODAttenuationDetails                AttenuationDetails;                                // 0x02E0(0x000C)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FFMODOcclusionDetails                  OcclusionDetails;                                  // 0x02EC(0x0003)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_2EF[0xE1];                                     // 0x02EF(0x00E1)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UFMODAudioComponent) == 0x0003D0, "Wrong size on UFMODAudioComponent");
static_assert(offsetof(UFMODAudioComponent, Event) == 0x000230, "Member 'UFMODAudioComponent::Event' has a wrong offset!");
static_assert(offsetof(UFMODAudioComponent, ParameterCache) == 0x000238, "Member 'UFMODAudioComponent::ParameterCache' has a wrong offset!");
static_assert(offsetof(UFMODAudioComponent, ProgrammerSoundName) == 0x000288, "Member 'UFMODAudioComponent::ProgrammerSoundName' has a wrong offset!");
static_assert(offsetof(UFMODAudioComponent, OnEventStopped) == 0x0002A0, "Member 'UFMODAudioComponent::OnEventStopped' has a wrong offset!");
static_assert(offsetof(UFMODAudioComponent, OnSoundStopped) == 0x0002B0, "Member 'UFMODAudioComponent::OnSoundStopped' has a wrong offset!");
static_assert(offsetof(UFMODAudioComponent, OnTimelineMarker) == 0x0002C0, "Member 'UFMODAudioComponent::OnTimelineMarker' has a wrong offset!");
static_assert(offsetof(UFMODAudioComponent, OnTimelineBeat) == 0x0002D0, "Member 'UFMODAudioComponent::OnTimelineBeat' has a wrong offset!");
static_assert(offsetof(UFMODAudioComponent, AttenuationDetails) == 0x0002E0, "Member 'UFMODAudioComponent::AttenuationDetails' has a wrong offset!");
static_assert(offsetof(UFMODAudioComponent, OcclusionDetails) == 0x0002EC, "Member 'UFMODAudioComponent::OcclusionDetails' has a wrong offset!");
...
public:
	...
	class UFMODAudioLinkSettings*                 Settings;                                          // 0x0238(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class USoundBase*                             Sound;                                             // 0x0240(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UAudioComponent*                        AudioComponent;                                    // 0x0248(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UFMODAudioLinkComponent) == 0x000260, "Wrong size on UFMODAudioLinkComponent");
static_assert(offsetof(UFMODAudioLinkComponent, Settings) == 0x000238, "Member 'UFMODAudioLinkComponent::Settings' has a wrong offset!");
static_assert(offsetof(UFMODAudioLinkComponent, Sound) == 0x000240, "Member 'UFMODAudioLinkComponent::Sound' has a wrong offset!");
static_assert(offsetof(UFMODAudioLinkComponent, AudioComponent) == 0x000248, "Member 'UFMODAudioLinkComponent::AudioComponent' has a wrong offset!");
...
public:
	...
	static class FString GetLocale();
...
static_assert(sizeof(UFMODSettings) == 0x0001C8, "Wrong size on UFMODSettings");
...
static_assert(offsetof(UFMODSettings, bFMODAudioLinkEnabled) == 0x000160, "Member 'UFMODSettings::bFMODAudioLinkEnabled' has a wrong offset!");
static_assert(offsetof(UFMODSettings, Platforms) == 0x000168, "Member 'UFMODSettings::Platforms' has a wrong offset!");
