...
static_assert(alignof(WBP_WorldSpace_Text_Heal_C_ExecuteUbergraph_WBP_WorldSpace_Text_Heal) == 0x000008, "Wrong alignment on WBP_WorldSpace_Text_Heal_C_ExecuteUbergraph_WBP_WorldSpace_Text_Heal");
static_assert(sizeof(WBP_WorldSpace_Text_Heal_C_ExecuteUbergraph_WBP_WorldSpace_Text_Heal) == 0x000048, "Wrong size on WBP_WorldSpace_Text_Heal_C_ExecuteUbergraph_WBP_WorldSpace_Text_Heal");
static_assert(offsetof(WBP_WorldSpace_Text_Heal_C_ExecuteUbergraph_WBP_WorldSpace_Text_Heal, EntryPoint) == 0x000000, "Member 'WBP_WorldSpace_Text_Heal_C_ExecuteUbergraph_WBP_WorldSpace_Text_Heal::EntryPoint' has a wrong offset!");
static_assert(offsetof(WBP_WorldSpace_Text_Heal_C_ExecuteUbergraph_WBP_WorldSpace_Text_Heal, K2Node_Event_Text) == 0x000008, "Member 'WBP_WorldSpace_Text_Heal_C_ExecuteUbergraph_WBP_WorldSpace_Text_Heal::K2Node_Event_Text' has a wrong offset!");
static_assert(offsetof(WBP_WorldSpace_Text_Heal_C_ExecuteUbergraph_WBP_WorldSpace_Text_Heal, CallFunc_PlayAnimationForward_ReturnValue) == 0x000018, "Member 'WBP_WorldSpace_Text_Heal_C_ExecuteUbergraph_WBP_WorldSpace_Text_Heal::CallFunc_PlayAnimationForward_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_WorldSpace_Text_Heal_C_ExecuteUbergraph_WBP_WorldSpace_Text_Heal, K2Node_Event_Animation) == 0x000020, "Member 'WBP_WorldSpace_Text_Heal_C_ExecuteUbergraph_WBP_WorldSpace_Text_Heal::K2Node_Event_Animation' has a wrong offset!");
