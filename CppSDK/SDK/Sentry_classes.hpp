...
static_assert(offsetof(USentrySettings, EnableTracing) == 0x0000C8, "Member 'USentrySettings::EnableTracing' has a wrong offset!");
static_assert(offsetof(USentrySettings, SamplingType) == 0x0000C9, "Member 'USentrySettings::SamplingType' has a wrong offset!");
...
public:
	...
	class USentryBeforeSendHandler*               BeforeSendHandler;                                 // 0x0050(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class USentryTraceSampler*                    TraceSampler;                                      // 0x0058(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(USentrySubsystem) == 0x000088, "Wrong size on USentrySubsystem");
static_assert(offsetof(USentrySubsystem, BeforeSendHandler) == 0x000050, "Member 'USentrySubsystem::BeforeSendHandler' has a wrong offset!");
static_assert(offsetof(USentrySubsystem, TraceSampler) == 0x000058, "Member 'USentrySubsystem::TraceSampler' has a wrong offset!");
