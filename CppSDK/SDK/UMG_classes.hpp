...
public:
	...
	struct FSlateFontInfo                         Font;                                              // 0x1CD8(0x0068)(Edit, BlueprintVisible, BlueprintReadOnly, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UComboBoxString) == 0x001DE0, "Wrong size on UComboBoxString");
...
static_assert(offsetof(UComboBoxString, ForegroundColor) == 0x001D40, "Member 'UComboBoxString::ForegroundColor' has a wrong offset!");
static_assert(offsetof(UComboBoxString, bIsFocusable) == 0x001D54, "Member 'UComboBoxString::bIsFocusable' has a wrong offset!");
static_assert(offsetof(UComboBoxString, OnGenerateWidgetEvent) == 0x001D58, "Member 'UComboBoxString::OnGenerateWidgetEvent' has a wrong offset!");
static_assert(offsetof(UComboBoxString, OnSelectionChanged) == 0x001D68, "Member 'UComboBoxString::OnSelectionChanged' has a wrong offset!");
static_assert(offsetof(UComboBoxString, OnOpening) == 0x001D78, "Member 'UComboBoxString::OnOpening' has a wrong offset!");
...
public:
	...
	struct FEditableTextStyle                     WidgetStyle;                                       // 0x01C0(0x0300)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
public:
	...
	TDelegate<void()>                             TextDelegate;                                      // 0x0188(0x0010)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_198[0x8];                                      // 0x0198(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FEditableTextBoxStyle                  WidgetStyle;                                       // 0x01A0(0x0E90)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	...
	struct FVirtualKeyboardOptions                VirtualKeyboardOptions;                            // 0x105F(0x0001)(Edit, NoDestructor, AdvancedDisplay, NativeAccessSpecifierPublic)
	EVirtualKeyboardTrigger                       VirtualKeyboardTrigger;                            // 0x1060(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EVirtualKeyboardDismissAction                 VirtualKeyboardDismissAction;                      // 0x1061(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ETextJustify                                  Justification;                                     // 0x1062(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ETextOverflowPolicy                           OverflowPolicy;                                    // 0x1063(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FShapedTextOptions                     ShapedTextOptions;                                 // 0x1064(0x0003)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, AdvancedDisplay, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UEditableTextBox, VirtualKeyboardOptions) == 0x00105F, "Member 'UEditableTextBox::VirtualKeyboardOptions' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, VirtualKeyboardTrigger) == 0x001060, "Member 'UEditableTextBox::VirtualKeyboardTrigger' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, VirtualKeyboardDismissAction) == 0x001061, "Member 'UEditableTextBox::VirtualKeyboardDismissAction' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, Justification) == 0x001062, "Member 'UEditableTextBox::Justification' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, OverflowPolicy) == 0x001063, "Member 'UEditableTextBox::OverflowPolicy' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, ShapedTextOptions) == 0x001064, "Member 'UEditableTextBox::ShapedTextOptions' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, OnTextChanged) == 0x001068, "Member 'UEditableTextBox::OnTextChanged' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, OnTextCommitted) == 0x001078, "Member 'UEditableTextBox::OnTextCommitted' has a wrong offset!");
...
public:
	...
	struct FTextBlockStyle                        TextStyle;                                         // 0x0570(0x0350)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
public:
	...
	struct FTextBlockStyle                        WidgetStyle;                                       // 0x01D0(0x0350)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
public:
	...
	class FText                                   HintText;                                          // 0x01B0(0x0010)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	TDelegate<void()>                             HintTextDelegate;                                  // 0x01C0(0x0010)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FEditableTextBoxStyle                  WidgetStyle;                                       // 0x01D0(0x0E90)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
public:
	...
	struct FTextBlockStyle                        DefaultTextStyleOverride;                          // 0x01D0(0x0350)(Edit, BlueprintVisible, Protected, NativeAccessSpecifierProtected)
	...
	struct FTextBlockStyle                        DefaultTextStyle;                                  // 0x0530(0x0350)(Transient, Protected, NativeAccessSpecifierProtected)
	TArray<class URichTextBlockDecorator*>        InstanceDecorators;                                // 0x0880(0x0010)(ZeroConstructor, Transient, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
...
static_assert(sizeof(URichTextBlock) == 0x0008B0, "Wrong size on URichTextBlock");
...
static_assert(offsetof(URichTextBlock, InstanceDecorators) == 0x000880, "Member 'URichTextBlock::InstanceDecorators' has a wrong offset!");
...
public:
	...
	struct FSlateFontInfo                         Font;                                              // 0x07A8(0x0068)(Edit, BlueprintVisible, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	struct FSlateFontInfo                         Font;                                              // 0x01E8(0x0068)(Edit, BlueprintVisible, HasGetValueTypeHash, NativeAccessSpecifierPublic)
