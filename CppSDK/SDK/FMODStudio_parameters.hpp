...
{
public:
	struct FFMODEventInstance                     EventInstance;                                     // 0x0000(0x0008)(Parm, NoDestructor, NativeAccessSpecifierPublic)
...
// Function FMODStudio.FMODBlueprintStatics.GetLocale
// 0x0010 (0x0010 - 0x0000)
struct FMODBlueprintStatics_GetLocale final
{
public:
	class FString                                 ReturnValue;                                       // 0x0000(0x0010)(Parm, OutParm, ZeroConstructor, ReturnParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FMODBlueprintStatics_GetLocale) == 0x000008, "Wrong alignment on FMODBlueprintStatics_GetLocale");
static_assert(sizeof(FMODBlueprintStatics_GetLocale) == 0x000010, "Wrong size on FMODBlueprintStatics_GetLocale");
static_assert(offsetof(FMODBlueprintStatics_GetLocale, ReturnValue) == 0x000000, "Member 'FMODBlueprintStatics_GetLocale::ReturnValue' has a wrong offset!");
...
public:
	...
	struct FFMODEventInstance                     ReturnValue;                                       // 0x0018(0x0008)(Parm, OutParm, ReturnParm, NoDestructor, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FFMODEventInstance                     ReturnValue;                                       // 0x0078(0x0008)(Parm, OutParm, ReturnParm, NoDestructor, NativeAccessSpecifierPublic)
};
