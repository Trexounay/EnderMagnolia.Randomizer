...
// (Final, Native, Static, Public, BlueprintCallable)
// Parameters:
// const struct FFMODEventInstance&        EventInstance                                          (Parm, NoDestructor, NativeAccessSpecifierPublic)
// class FName                             Name_0                                                 (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// float                                   ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
class FString UFMODBlueprintStatics::GetLocale()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("FMODBlueprintStatics", "GetLocale");

	Params::FMODBlueprintStatics_GetLocale Parms{};
