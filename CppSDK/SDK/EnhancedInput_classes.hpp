...
public:
	...
	uint8                                         Pad_778[0x78];                                     // 0x0778(0x0078)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<struct FKey, class UInputAction*>        LockedKeys;                                        // 0x07F0(0x0050)(Transient, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UEnhancedPlayerInput, LockedKeys) == 0x0007F0, "Member 'UEnhancedPlayerInput::LockedKeys' has a wrong offset!");
...
public:
	...
	bool                                          bConsumeInputOnTriggerOnly;                        // 0x0040(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bTriggerWhenPaused;                                // 0x0041(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UInputAction, bConsumeInputOnTriggerOnly) == 0x000040, "Member 'UInputAction::bConsumeInputOnTriggerOnly' has a wrong offset!");
static_assert(offsetof(UInputAction, bTriggerWhenPaused) == 0x000041, "Member 'UInputAction::bTriggerWhenPaused' has a wrong offset!");
