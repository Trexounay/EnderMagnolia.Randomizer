...
static_assert(sizeof(UAudioOscilloscope) == 0x0006B0, "Wrong size on UAudioOscilloscope");
...
static_assert(offsetof(UAudioOscilloscope, AudioBus) == 0x000640, "Member 'UAudioOscilloscope::AudioBus' has a wrong offset!");
static_assert(offsetof(UAudioOscilloscope, TimeWindowMs) == 0x000648, "Member 'UAudioOscilloscope::TimeWindowMs' has a wrong offset!");
static_assert(offsetof(UAudioOscilloscope, AnalysisPeriodMs) == 0x00064C, "Member 'UAudioOscilloscope::AnalysisPeriodMs' has a wrong offset!");
static_assert(offsetof(UAudioOscilloscope, bShowTimeGrid) == 0x000650, "Member 'UAudioOscilloscope::bShowTimeGrid' has a wrong offset!");
static_assert(offsetof(UAudioOscilloscope, TimeGridLabelsUnit) == 0x000651, "Member 'UAudioOscilloscope::TimeGridLabelsUnit' has a wrong offset!");
static_assert(offsetof(UAudioOscilloscope, bShowAmplitudeGrid) == 0x000652, "Member 'UAudioOscilloscope::bShowAmplitudeGrid' has a wrong offset!");
static_assert(offsetof(UAudioOscilloscope, bShowAmplitudeLabels) == 0x000653, "Member 'UAudioOscilloscope::bShowAmplitudeLabels' has a wrong offset!");
static_assert(offsetof(UAudioOscilloscope, AmplitudeGridLabelsUnit) == 0x000654, "Member 'UAudioOscilloscope::AmplitudeGridLabelsUnit' has a wrong offset!");
static_assert(offsetof(UAudioOscilloscope, bShowTriggerThresholdLine) == 0x000655, "Member 'UAudioOscilloscope::bShowTriggerThresholdLine' has a wrong offset!");
static_assert(offsetof(UAudioOscilloscope, TriggerThreshold) == 0x000658, "Member 'UAudioOscilloscope::TriggerThreshold' has a wrong offset!");
static_assert(offsetof(UAudioOscilloscope, PanelLayoutType) == 0x00065C, "Member 'UAudioOscilloscope::PanelLayoutType' has a wrong offset!");
